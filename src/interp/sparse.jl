...
immutable SparseInterpolator{T<:AbstractFloat,S,N} <: LinearOperator{AbstractArray{T,N},
                                                                     AbstractVector{T}}
    C::Vector{T}
    J::Vector{Int}
    nrows::Int
    ...
    function SparseInterpolator(C::Vector{T}, J::Vector{Int}, dims::NTuple{N,Int},
                                ncols::Int)
        @assert S ≥ 1
